  ...
  return (
    <div className='p-4 h-auto bg-[#f0f0f0]'>
        ...
        <div className={`relative ${previewPage ? 'h-[320px]' : 'h-[230px]'} p-2 flex justify-center items-center mt-1 bg-[#cddbf2] min-w-[100px]`}>
            ...
            <Input onChange={(e) => handleChange(e)} type='file' className={`opacity-0 outline-none border-none rounded-none`} labelProps={{ className: 'before:mr-0 after:ml-0 hidden', }} crossOrigin={undefined} />
