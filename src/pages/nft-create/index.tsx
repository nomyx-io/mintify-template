...
export default function Details({service}: any) {
    ...
    // Set state for all fields normally
        ...
        if (name === "loanAmount" || name === "term" || name === "yields") {
            const loanAmountValue = name === "loanAmount" ? parseFloat(value) : parseFloat(loanAmount);
            const termValue = name === "term" ? parseFloat(value) : parseFloat(term);
            // assuming yields field relates to the annual interest rate
            const interestRateValue = name === "yields" ? parseFloat(value) : parseFloat(yields);

            if (!isNaN(loanAmountValue) && !isNaN(termValue) && !isNaN(interestRateValue)) {
                try {
                    const monthlyPayment = calculateMonthlyLoanPayment(loanAmountValue, termValue, interestRateValue);
        ...
        if(name=="loanId" || name=="loanAmount" || name=="yield"){
            ...
            const loanAmountValue = name === "loanAmount" ? parseFloat(value) : loanAmount ? parseFloat(loanAmount) : "";
            const interestRateValue = name === "yields" ? parseFloat(value) : yields ? parseFloat(yields) : "";
    ...
    const fields = [
        ...
        },
        {
            ...
            rules: [requiredRule, {
                ...
                message: "Please enter a value with up to 10 digits and 2 decimal places."
            }]
        },
        ...
        },
        {
            ...
            rules: [requiredRule, {
                ...
                message: "Please enter a value with up to 9 digits and 2 decimal places."
            }]
        },
...

        {
            ...
            rules: [requiredRule, {
                ...
                message: "Please enter a value with up to 2 digits and 3 decimal places."
            }]
        },
        {
            label: '',
...

        {
            ...
            rules: [requiredRule, {
                ...
                message: "Please enter a value with up to 2 digits and 2 decimal places."
            }]
        },
        {
            label: '',
